...
#################
# Clean out folder
rm -rf '/media/system/root1/android_kernel_sdm660_zeus-kernel/out'
# Set defaults
cd "/media/system/root1/android_kernel_sdm660_zeus-kernel"
wd=$(pwd)
out=$wd/out
BUILD="/media/system/root1/android_kernel_sdm660_zeus-kernel"
...
# Compiler String
CC=/media/system/root1/aosp-clang/clang-10
...
# mounting to browser
cd "/media/system/root1/android_kernel_sdm660_zeus-kernel/out/arch/arm64/boot"
